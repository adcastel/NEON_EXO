...
Ci.data[3 * Ci.strides[0] + 1] = C[25];
Ci.data[3 * Ci.strides[0] + 2] = C[26];
Ci.data[3 * Ci.strides[0] + 3] = C[27];
Ci.data[3 * Ci.strides[0] + 4] = C[28];
free(C);
}
