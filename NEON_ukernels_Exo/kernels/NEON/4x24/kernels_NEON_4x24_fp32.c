#include "kernels_NEON_4x24_fp32.h"
...
// assert stride(Ci, 1) == 1
float32x4_t A_reg;
float32x4_t B_reg_0, B_reg_1, B_reg_2, B_reg_3, B_reg_4, B_reg_5;;
float *C = (float*) malloc(24 * 4 * sizeof(*C));
float32x4_t C_reg_0;
float32x4_t C_reg_1;
float32x4_t C_reg_2;
float32x4_t C_reg_3;
...
float32x4_t C_reg_18;
float32x4_t C_reg_19;
float32x4_t C_reg_20;
float32x4_t C_reg_21;
float32x4_t C_reg_22;
float32x4_t C_reg_23;
C_reg_0 = vmovq_n_f32(0.0f);
C_reg_1 = vmovq_n_f32(0.0f);
C_reg_2 = vmovq_n_f32(0.0f);
C_reg_3 = vmovq_n_f32(0.0f);
...
C_reg_18 = vmovq_n_f32(0.0f);
C_reg_19 = vmovq_n_f32(0.0f);
C_reg_20 = vmovq_n_f32(0.0f);
C_reg_21 = vmovq_n_f32(0.0f);
C_reg_22 = vmovq_n_f32(0.0f);
C_reg_23 = vmovq_n_f32(0.0f);
for (int_fast32_t k = 0; k < KC; k++) {
  A_reg = vld1q_f32(&A[(k) * (4)]);
  B_reg_0 = vld1q_f32(&B[(k) * (24)]);
  B_reg_1 = vld1q_f32(&B[(k) * (24) + 4]);
  ...
  C_reg_18 = vfmaq_laneq_f32(C_reg_18, A_reg, B_reg_4, (2));
  C_reg_19 = vfmaq_laneq_f32(C_reg_19, A_reg, B_reg_4, (3));
  C_reg_20 = vfmaq_laneq_f32(C_reg_20, A_reg, B_reg_5, (0));
  C_reg_21 = vfmaq_laneq_f32(C_reg_21, A_reg, B_reg_5, (1));
  C_reg_22 = vfmaq_laneq_f32(C_reg_22, A_reg, B_reg_5, (2));
  C_reg_23 = vfmaq_laneq_f32(C_reg_23, A_reg, B_reg_5, (3));
}
vst1q_f32(&C[0], C_reg_0);
vst1q_f32(&C[4], C_reg_1);
vst1q_f32(&C[(2) * 4], C_reg_2);
...
vst1q_f32(&C[(18) * 4], C_reg_18);
vst1q_f32(&C[(19) * 4], C_reg_19);
vst1q_f32(&C[(20) * 4], C_reg_20);
vst1q_f32(&C[(21) * 4], C_reg_21);
vst1q_f32(&C[(22) * 4], C_reg_22);
vst1q_f32(&C[(23) * 4], C_reg_23);
Ci[0] = C[0];
Ci[ldci] = C[4];
Ci[2 * ldci] = C[8];
Ci[3 * ldci] = C[12];
...
for (int_fast32_t k = 0; k < KC; k++) {
  A_reg_0 = vld1q_f32(&A[(k) * (4)]);
  B_reg_0 = vld1q_f32(&B[(k) * (24)]);
  B_reg_1 = vld1q_f32(&B[(k) * (24) + (4) * (1)]);
  B_reg_2 = vld1q_f32(&B[(k) * (24) + (8) * (1)]);
  C_reg_0_0 = vfmaq_laneq_f32(C_reg_0_0, A_reg_0, B_reg_0, (0));
  C_reg_1_0 = vfmaq_laneq_f32(C_reg_1_0, A_reg_0, B_reg_0, (1));
  C_reg_2_0 = vfmaq_laneq_f32(C_reg_2_0, A_reg_0, B_reg_0, (2));
  C_reg_3_0 = vfmaq_laneq_f32(C_reg_3_0, A_reg_0, B_reg_0, (3));
...
vst1q_f32(&C[(18) * 4], C_reg_18_0);
vst1q_f32(&C[(19) * 4], C_reg_19_0);
vst1q_f32(&C[(20) * 4], C_reg_20_0);
vst1q_f32(&C[(21) * 4], C_reg_21_0);
vst1q_f32(&C[(22) * 4], C_reg_22_0);
vst1q_f32(&C[(23) * 4], C_reg_23_0);
Ci[0] = C[0];
Ci[1] = C[1];
Ci[2] = C[2];
Ci[3] = C[3];
...
vst1q_f32(&C[(18) * (ldc)], C_reg_18_0);
vst1q_f32(&C[(19) * (ldc)], C_reg_19_0);
vst1q_f32(&C[(20) * (ldc)], C_reg_20_0);
vst1q_f32(&C[(21) * (ldc)], C_reg_21_0);
vst1q_f32(&C[(22) * (ldc)], C_reg_22_0);
vst1q_f32(&C[(23) * (ldc)], C_reg_23_0);
}
...
C_reg_18_0 = vld1q_f32(&C[(18) * (ldc)]);
C_reg_19_0 = vld1q_f32(&C[(19) * (ldc)]);
C_reg_20_0 = vld1q_f32(&C[(20) * (ldc)]);
C_reg_21_0 = vld1q_f32(&C[(21) * (ldc)]);
C_reg_22_0 = vld1q_f32(&C[(22) * (ldc)]);
C_reg_23_0 = vld1q_f32(&C[(23) * (ldc)]);
for (int_fast32_t k = 0; k < KC; k++) {
  A_reg_0 = vld1q_f32(&A[(k) * (4)]);
  B_reg_0 = vld1q_f32(&B[(k) * (24)]);
  B_reg_1 = vld1q_f32(&B[(k) * (24) + (4) * (1)]);
